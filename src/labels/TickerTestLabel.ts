import { CanvasSprite, GameWindowManager, Label, labelDecorator, Pause, removeCanvasElement, Repeat, setDialogue, StepLabelType, TickerFadeAlpha, TickerRotate } from "@drincs/pixi-vn";
