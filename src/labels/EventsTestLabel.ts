import { CanvasEvent, CanvasEventNamesType, CanvasSprite, clearDialogue, eventDecorator, GameWindowManager, Label, labelDecorator, setDialogue, StepLabelType } from "@drincs/pixi-vn";
