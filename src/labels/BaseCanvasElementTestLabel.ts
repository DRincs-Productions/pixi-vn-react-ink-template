import { CanvasContainer, CanvasSprite, CanvasText, clearDialogue, GameWindowManager, Label, labelDecorator, removeCanvasElement, StepLabelType, TickerRotate } from "@drincs/pixi-vn";
